...
Conforme estabelecido pelo relatório técnico IEEE TR77, a penetração maciça de conversores estáticos introduz a categoria de Estabilidade Guiada por Conversores (*Converter-Driven Stability*). Nesse cenário, a dinâmica da malha de sincronismo (SRF-PLL) passa a interagir de forma direta com a impedância equivalente do sistema elétrico. Sob condições de desequilíbrio na rede, a presença da componente de sequência negativa induz uma ondulação de segunda harmônica (2ω0, correspondente a 120 Hz no sistema de 60 Hz) no referencial síncrono d-q. Como o SRF-PLL convencional não dispõe de filtros de rejeição específicos para essa componente, a capacidade de manutenção do sincronismo fica estritamente vinculada ao amortecimento e à largura de banda impostos pelo controlador PI do laço.
