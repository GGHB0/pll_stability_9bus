...
Essas quedas de tensão afetam todas as barras do sistema elétrico. Nas máquinas síncronas, o distúrbio provoca um grave desequilíbrio entre a potência mecânica e a potência elétrica (KUNDUR, 1994). Para os inversores, o impacto no Ponto de Conexão Comum (PCC) é crítico: o PLL necessita de uma tensão estável para operar. Sem o rastreamento adequado durante o afundamento, o inversor apresenta mau funcionamento e falha em fornecer o suporte de potência exigido pelos códigos de rede.
