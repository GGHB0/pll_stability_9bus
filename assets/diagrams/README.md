...
| `vsi_lcl_pwm_circuit.svg` / `.png` | SVG (circuito + controle) | Figura 3.1 do TCC — sistema GFL completo: circuito VSI trifasico 2 niveis (IGBTs S1-S6 + diodos antiparalelos), filtro LCL (L1/Cf/L2), sensores i_abc e u_abc, PAC Barra 2, e controle digital detalhado (abc->dq, SRF-PLL, logica ONS Subm. 2.10 / ONS_2_11 gerando i_d,ref e i_q,ref, PIs de corrente dq, dq->abc, PWM) | `.claude/kb/inverter/lcl_filter.md`, `.claude/kb/inverter/simulink_model.md`, `.claude/kb/standards/ons_2_11.md` |
