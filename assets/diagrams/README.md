...
| `roadmap_estabilidade_sistema.svg` / `.png` | SVG (linha do tempo / chevron) | Recriacao traduzida (PT) da "Figure 2 — Central milestones of the system stability roadmap" do roadmap alemao: seta cronologica 2024→2030+ com gradiente teal, 19 marcos MS1-MS18 (12a/12b) em caixas acima/abaixo por ano. Fonte da secao 2.3 do TCC (classificacao estendida de estabilidade) | `.claude/kb/power-system/stability_classification_extended.md` (Strauss-Mincu et al. / Roadmap alemao) |
