...
SCENARIOS = [
    ...
    dict(folder="bus7/2phase", prefix="bus7_2phase", bus="Barra 7", fault_type="2phase"),
    dict(folder="bus7/2phase_bad_pll", prefix="bus7_2phase_bad_pll", bus="Barra 7", fault_type="2phase"),
    dict(folder="bus6/1phase", prefix="bus6_1phase", bus="Barra 6", fault_type="1phase"),
    dict(folder="bus6/1phase_bad_pll", prefix="bus6_1phase_bad_pll", bus="Barra 6", fault_type="1phase"),
